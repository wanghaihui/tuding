...
//  private static final int MAX_FRAME_WIDTH = 960; // = 1920/3*2
//  private static final int MAX_FRAME_HEIGHT = 560; // = 1080/3*2
  private static final int MAX_FRAME_WIDTH = 1280; // = 1920/3*2
  private static final int MAX_FRAME_HEIGHT = 720; // = 1080/3*2
...
//    int dim = resolution / 2; // Target 50% of each dimension
    int dim = resolution / 3 * 2; // Target 66% of each dimension
    if (dim < hardMin) {
      return hardMin;
    }
    if (dim > hardMax) {
