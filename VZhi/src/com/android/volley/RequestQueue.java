...
public class RequestQueue {
    ...
    public void start() {
        ...
        for (int i = 0; i < mDispatchers.length; i++) {
            ...
            Logcat.d("@@@", "request queue start():" + mDispatchers.length);
        }
    }
     ...
     * @return The passed-in(传入的) request
     */
    // 泛型方法
