package com.xiaobukuaipao.vzhi.core;
...
import com.xiaobukuaipao.vzhi.util.MD5;
...
public class ImageManager {
		...
		private static VZhiApplication myapp;
		...
		public static ImageManager from(Context context) {
			...
			if (myapp == null) {
				myapp = (VZhiApplication) context.getApplicationContext();
			}
