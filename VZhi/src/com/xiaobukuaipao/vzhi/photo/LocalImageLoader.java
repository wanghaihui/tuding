...
public class LocalImageLoader {
	...
	public static final String TAG = LocalImageLoader.class.getSimpleName();
    /**
     * 内存Lru缓存
     */
    ...
    private LocalImageLoader() {
        ...
        Log.i(TAG, "Phone max memory : " + maxMemory);
        // 用最大内存的1/8来存储图片
        ...
        mThreadPool.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (size == null || size.x == 0 || size.y == 0) {
                    size = DeviceUtil.getDeviceSize(VZhiApplication.getInstance());
                }
                // 先获取图片的缩略图
     ...
     * 清空正在请求的请求列表
     */
    public void clearOnLoadingList() {
    	mOnLoadingList.clear();
    }
