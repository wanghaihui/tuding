...
//        final String bestDateTimePattern = DateFormat.getBestDateTimePattern(defaultLocale, (mIs24HourView) ? "Hm" : "hm");
//        Logcat.d("@@@", "bestDateTimePattern:" + bestDateTimePattern);
    	final String bestDateTimePattern = "HH:mm";
...
//        //TODO 
//        final String bestDateTimePattern = DateFormat.getBestDateTimePattern(defaultLocale,skeleton);
//        Logcat.d("@@@", "bestDateTimePattern:" + bestDateTimePattern);
        final String bestDateTimePattern = "HH:mm";
    ...
    private void setContentDescriptions() {
        // Minute
        trySetContentDescription(mMinuteSpinner, R.id.np__increment, R.string.time_picker_increment_minute_button);
        trySetContentDescription(mMinuteSpinner, R.id.np__decrement, R.string.time_picker_decrement_minute_button);
        // Hour
	...
	public void setHalf(boolean isHalf) {
		this.isHalf = isHalf;
        if(isHalf){
            minutes = getContext().getResources().getStringArray(R.array.time_picker_minute);
        	//只有10及以上才能循环显示
        	mMinuteSpinner.setMaxValue(minutes.length - 1);
        	mMinuteSpinner.setFormatter(new Formatter() {
				
				@Override
				public String format(int value) {
					return minutes[value % (minutes.length)];
				}
			});
