...
import com.xiaobukuaipao.vzhi.widget.ViewPager.OnPageChangeListener;
	...
	private void addTab(final int position, View tab) {
		...
		tab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (!pager.getSlidingPanelOpening()) {
			...
			public boolean onTouch(View v, MotionEvent event) {
				switch (event.getAction()) {
					...
					case MotionEvent.ACTION_UP:
						if (pager.getSlidingPanelOpening()) {
							pager.getSlidingPaneLayout().closePane();
						}
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			if (mSlidingPaneLayout != null) {
				mSlidingPaneLayout.setCurrentViewPagerIndex(position);
			}
		}
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
