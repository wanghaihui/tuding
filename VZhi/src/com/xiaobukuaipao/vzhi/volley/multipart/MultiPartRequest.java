...
/**
 * Request supports multipart uploading, this request can be supported with
 * volley library rewrite.
 * 
 * @version [Android-BaseLine, 2014-9-22]
 */
public abstract class MultiPartRequest<T> extends Request<T> implements
		ProgressListener {
	/** Charset for request. */
	 ...
	 */
	public MultiPartRequest<T> addMultipartParam(String name,
