...
public class FilePart extends BasePart {
	 ...
	 * @param filename
	 *            String. If <code>null</code> is passed, then
	 *            <code>file.getName()</code> is used.
	 * @param contentType
	 *            String. If <code>null</code> is passed, then default
	 *            "application/octet-stream" is used.
	 * 
	 * @throws IllegalArgumentException
	 *             if either <code>file</code> or <code>name</code> is
	 *             <code>null</code>.
	 */
	public FilePart(String name, File file, String filename, String contentType) {
		...
		this.file = file;
		final String partName = UrlEncodingHelper.encode(name,
		...
		headersProvider = new IHeadersProvider() {
			public String getContentDisposition() {
				return String.format(HEADER_CONTENT_DISPOSITION + COLON_SPACE
						+ FORM_DATA + SEMICOLON_SPACE + FILENAME, partName,
						partFilename);
			}
