...
public class SearchTalentPreviewActivity extends PositionWrapActivity {
	...
	private TextView mHotPositionView;
	
	@Override
	public void initUIAndData() {
		setContentView(R.layout.activity_search_talent_preview);
		setHeaderMenuByLeft(this);
		
		mSearchLayout = (View) findViewById(R.id.menu_bar_search_btn_layout);
		mSearchBar = (EditTextWithDel) findViewById(R.id.search_talent_edit);
		
		mHotPositionView = (TextView) findViewById(R.id.hot_position_text);
		
		mGridList = new ArrayList<Profession>();
		initGridList();
		mGridView = (NestedGridView) findViewById(R.id.search_talents);
	...
	private void setUIListeners() {
		mGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				Intent intent = new Intent(SearchTalentPreviewActivity.this, SearchTalentActivity.class);
		...
		if (msg.obj instanceof InfoResult) {
			...
			switch (msg.what) {
				case R.id.get_suggested_position:
					...
					mHotPositionView.setVisibility(View.VISIBLE);
