...
public class FlingCardListener implements View.OnTouchListener {
    ...
    public FlingCardListener(View frame, Object itemAtPosition, FlingListener flingListener) {
        this(frame,itemAtPosition, 15f, flingListener, null);
    }

    
	public FlingCardListener(View frame, Object itemAtPosition, float rotation_degrees, FlingListener flingListener, ViewPager viewPager) {
        super();
        this.frame = frame;
