 ...
 *	工作经历职位名称
 *
 *	@since 2015年01月13日17:44:31
 */
public class JobNameFragment extends CallBackFragment {
	/**
	 * 
	 */
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
		...
		setHeaderMenuByRight(R.string.general_tips_save).setOnClickListener(
				new OnClickListener() {
					...
					public void onClick(View v) {
						mExperience.setPosition(mEditText.getText().toString());
        ...
        mEditText = (A5EditText) getActivity().findViewById(R.id.edittext1);
 		...
 		mEditText.setText(StringUtils.isEmpty(mExperience.getPosition()) ? "" : mExperience.getPosition());
